...
PanelWindow {
    ...
    Rectangle {
        ...
        x: {
            ...
            if (card.anchorEdge === "left")  return card.anchorGap;
            if (card.anchorEdge === "right") return parent.width - width - card.anchorGap;
        ...
        y: {
            ...
            if (card.anchorEdge === "top")    return card.anchorGap;
            if (card.anchorEdge === "bottom") return parent.height - height - card.anchorGap;
            return Math.max(card.anchorGap,
