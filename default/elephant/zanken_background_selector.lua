Name = "zankenBackgroundSelector"
NamePretty = "Zanken Background Selector"
Cache = false
...
function GetEntries()
  ...
  local theme_name_file = io.open(home .. "/.config/zanken/current/theme.name", "r")
  ...
  local dirs = {
    home .. "/.config/zanken/current/theme/backgrounds",
  }
  if theme_name then
    table.insert(dirs, home .. "/.config/zanken/backgrounds/" .. theme_name)
  end
      ...
      for background in handle:lines() do
        ...
        if filename and not seen[filename] then
          ...
          table.insert(entries, {
            ...
            Value = background,
            Actions = {
              activate = "zanken-theme-bg-set " .. ShellEscape(background),
            },
            Preview = background,
            PreviewType = "file",
          })
