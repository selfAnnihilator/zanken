--
-- Dynamic Zanken Theme Menu for Elephant/Walker
--
Name = "zankenthemes"
NamePretty = "Zanken Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/zanken/themes"
  local zanken_path = os.getenv("OMARCHY_PATH") or ""
  local default_theme_dir = zanken_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "zanken-theme-set " .. theme_name,
            },
          })
        end
      end
